...
# ===========================================================================
HOST = "elshogu"   # shown as  elshogu@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Student & Developer in Progress"),
    ("kv", "Doing", "Web, Mobile & System Design"),
    ("kv", "Daily", "Arch Linux + Hyprland"),
    ("kv", "Fuel", "Coffee, curiosity and Monster"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Langs", "TypeScript, Java, Python"),
    ("kv", "Mobile", "React Native, Expo, Kotlin"),
    ("kv", "Web", "Vue, Laravel/Blade, JS"),
    ("kv", "Data", "Supabase, PostgreSQL"),
    ("kv", "Shell", "Bash, Lua, Nix"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Upp_map - campus map, Expo + Supabase"),
    ("bul", "TelegramBot - AI bot, Java + Docker"),
    ("bul", "wayland-dotfiles - my whole rice"),
]
